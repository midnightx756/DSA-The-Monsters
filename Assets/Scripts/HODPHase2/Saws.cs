...
public class Saws : MonoBehaviour
{
    ...
    GameObject Saw1, Saw2;

    [Header("Positioning")]
    [SerializeField] GameObject ground;
    [SerializeField] float xOFF = 0f;
    [SerializeField] float yOFF = 0f;
    ...
    void Start()
    {
     ...
     void Update()
    {
        ob.x = ground.transform.position.x + xOFF;
        ob.y = ground.transform.position.y + yOFF;
